          ...
          <table role="presentation" width="640" cellspacing="0" cellpadding="0" border="0" style="width:640px;max-width:100%;background:#1a1a1a;border:1px solid rgba(255,255,255,0.05);">
            ...
            <tr>
              <td style="padding:40px 32px 32px;border-bottom:1px solid rgba(255,255,255,0.08);text-align:center;">
                <div>
                  <a href="${escapeHtml(canonicalSiteUrl)}" style="font-family:'Playfair Display', sans-serif;font-style:italic;font-size:11px;letter-spacing:0.08em;color:rgba(255,255,255,0.5);text-decoration:none;border-bottom:1px solid rgba(255,255,255,0.3);">
                    View in browser
                  </a>
                </div>
            ...
            ${
              ...
              <td style="padding:24px 32px;text-align:center;">
                <img src="${escapeHtml(hero)}" width="420" style="width:100%;max-width:420px;height:auto;display:inline-block;border:0;" alt="${escapeHtml(title)}" />
              </td>
            </tr>`
                : ''
            }
