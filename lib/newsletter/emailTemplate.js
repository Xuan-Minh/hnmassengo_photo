      ...
      <tr>
        <td align="center" style="padding:48px 16px;">
          <table role="presentation" width="640" cellspacing="0" cellpadding="0" border="0" style="width:640px;max-width:100%;background:#1a1a1a;border:1px solid rgba(255,255,255,0.05);">
            ...
            <!-- Content -->
            <tr>
              <td style="padding:32px 32px 24px;font-family:'Lexend', sans-serif;font-size:14px;line-height:1.7;color:rgba(255,255,255,0.85);font-weight:400; text-align:center;">
                ${escapeHtml(snippet)}
              </td>
            </tr>
