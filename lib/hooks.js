...
export function getOptimizedImageParams(imageType = 'secondary') {
  ...
  const params = {
    lcp: isProduction
      ? { w: 800, q: 75, dpr: 1 } // Augmenté pour les Hero images
      : { w: 800, q: 50, dpr: 1 },
    secondary: isProduction
      ? { w: 800, q: 75, dpr: 1 } // Augmenté pour les articles de blog
      : { w: 600, q: 50, dpr: 1 },
    gallery: isProduction
      ? { w: 1600, q: 80, dpr: 1 } // Augmenté pour la galerie plein écran
      : { w: 2000, q: 55, dpr: 1 },
    shop: isProduction
      ? { w: 800, q: 80, dpr: 1 } // ⚠️ MODIFIÉ ICI : 800px de large et qualité 80%
      : { w: 500, q: 55, dpr: 1 },
    loading: {
      w: 1200, // Plus large pour la netteté
      q: 60, // Qualité standard (beaucoup mieux que 15, mais moins lourd que 100)
      blur: 10, // Optionnel : ajoute un léger flou pour masquer la compression
    },
  };
