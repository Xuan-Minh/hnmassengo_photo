...
export function getOptimizedImageParams(imageType = 'secondary') {
  ...
  const params = {
    lcp: isProduction
      ? { w: 380, q: 35, dpr: 1 } // Hero image - most aggressively optimized
      : { w: 800, q: 50, dpr: 1 },
    secondary: isProduction
      ? { w: 500, q: 42, dpr: 1 } // Blog/post images
      : { w: 600, q: 50, dpr: 1 },
    gallery: isProduction
      ? { w: 1200, q: 42, dpr: 1 } // Gallery full-width carousel (reduced from 1600)
      : { w: 2000, q: 55, dpr: 1 },
    shop: isProduction
      ? { w: 400, q: 38, dpr: 1 } // Product thumbnails
      : { w: 500, q: 55, dpr: 1 },
  };
