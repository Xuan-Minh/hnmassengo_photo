...
export function useUIVisibility(includeShopException = false) {
  ...
  // Utilisation de useSyncExternalStore pour remplacer le useState+useEffect
  // Permet d'éviter le double-rendu au chargement de la page et satisfait le linter.
 ...
 * @param {string} breakpoint - La largeur max pour considérer l'écran comme "mobile" (défaut: 1024px)
 * @returns {boolean}
 */
