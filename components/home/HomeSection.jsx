...
export default function HomeSection() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-[1275px] flex-col gap-10 px-6 pt-24 pb-12 sm:px-8 lg:flex-row lg:items-start lg:gap-14 lg:px-12 lg:pt-32 lg:pb-16 xl:px-16">
        <div className="relative mx-auto aspect-[3/4] w-full max-w-[560px] lg:mx-0 lg:w-[42%]">
          <Image
            src={heroImage}
        ...
        <div className="w-full lg:w-[58%] lg:pt-6">
          {bioTitle ? (
            <h2 className="mb-5 font-playfair text-[40px] leading-[1.05] text-blackCustom sm:text-[46px] lg:text-[54px] xl:text-[62px]">
              {bioTitle}
            </h2>
          ) : null}
          <p className="whitespace-pre-line font-playfair italic text-[18px] leading-[1.3] text-blackCustom sm:text-[20px] lg:text-[24px] xl:text-[18px]">
            {bioText}
          </p>
        </div>
      </div>
