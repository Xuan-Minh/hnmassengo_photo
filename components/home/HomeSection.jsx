...
export default function HomeSection() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-[1200px] xl:max-w-[1600px] 2xl:max-w-[2000px] flex-col gap-10 px-6 pt-24 pb-12 sm:px-8 lg:flex-row lg:items-center lg:gap-14 lg:px-12 lg:py-32  xl:px-16 2xl:px-24">
