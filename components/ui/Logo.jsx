...
export default function Logo({ visible = true }) {
  ...
  return (
    <div
      ...
      className={`absolute top-0 left-1/2 transform -translate-x-1/2 justify-center gap-2 m-4 items-center space-x-2 z-50 bg-transparent pointer-events-none hidden lg:flex lg:text-[36px] transition-opacity duration-300 ${visible ? 'opacity-100' : 'opacity-0'}`}
    >
      <span
