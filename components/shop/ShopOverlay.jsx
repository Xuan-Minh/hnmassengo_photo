    ...
    <BaseOverlay onClose={onClose} ariaLabelledBy="shop-product-title">
      ...
      <div className="flex-1 w-full h-full flex flex-col md:flex-row p-0 md:p-16">
        ...
        <div className="md:hidden w-full">
          ...
          {/* Séparateur */}
          <div className="border-t border-whiteCustom/20" />
          {/* Infos 50vh */}
          <div className="h-[50vh] flex flex-col items-start p-8 overflow-y-auto">
        ...
        {/* DESKTOP */}
        <div className="hidden md:flex flex-1 items-center justify-center gap-24 w-full h-full">
          {/* Image */}
