  ...
  return (
    ...
    >
      ...
      <main className="flex-1 h-full flex flex-col md:flex-row items-stretch overflow-hidden">
        {/* Panier mobile (en bas, 50vh), desktop (gauche, 320px) */}
        <aside className="w-full md:w-[320px] h-[50vh] md:h-full border-t md:border-t-0 md:border-r border-black/30 p-6 md:p-10 flex flex-col z-10 bg-whiteCustom order-2 md:order-1">
